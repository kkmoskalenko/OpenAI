...
final public class OpenAI: OpenAIProtocol {
    ...
    public struct Configuration {
        ...
        public init(token: String, organizationIdentifier: String? = nil, host: String = "api.openai.com", pathPrefix: String = "", port: Int = 443, scheme: String = "https", timeoutInterval: TimeInterval = 60.0) {
            self.token = token
